...
async function showPopup()
{
    ...
    {*/
        if ( localStorage.ImAc_cookies == undefined ) localStorage.ImAc_cookies = confirm("Do you give us consent to register metrics for research purposes?");
        init_webplayer()
    //}
}
...
function init_webplayer()
{
    ...
    _moData.setFont('./css/fonts/TiresiasScreenfont_Regular.json').then(() => { 
        ...
        //Remote
	//$.getJSON("http://3.122.159.178/html/content.json") 
        $.getJSON("/ImmersiveAdaptivePlayer/content.json") 
        //Local            
