...
//************************************************************************************
    ...
    this.initAmbisonicResources = function()
    {
        ...
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-1.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-2.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-3.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-4.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-5.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-6.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-7.wav' );
        audioResources.push( '/ImmersiveAdaptivePlayer/resources/omnitone-toa-8.wav' );

        audioResources_order_1.push( '/ImmersiveAdaptivePlayer/resources/omnitone-foa-1.wav' );
        audioResources_order_1.push( '/ImmersiveAdaptivePlayer/resources/omnitone-foa-2.wav' );
    };
